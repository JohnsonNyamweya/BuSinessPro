...
public class CategoryOfGamingActivity extends AppCompatActivity {

    private DatabaseReference gamingReference;
    private RecyclerView categoryOfGamingRv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_category_of_gaming);

        gamingReference = FirebaseDatabase.getInstance().getReference().child("Products");

        categoryOfGamingRv = findViewById(R.id.category_of_gaming_rv);
        categoryOfGamingRv.setHasFixedSize(true);
        layoutManager = new LinearLayoutManager(this);
        categoryOfGamingRv.setLayoutManager(layoutManager);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerOptions<Products> options = new FirebaseRecyclerOptions.Builder<Products>()
                .setQuery(gamingReference.orderByChild("category").equalTo("Gaming"), Products.class)
                .build();
                    ...
                    protected void onBindViewHolder(@NonNull ProductsViewHolder holder, int position, @NonNull Products model) {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                Intent productDetailsIntent = new Intent(CategoryOfGamingActivity.this,
        ...
        categoryOfGamingRv.setAdapter(adapter);
